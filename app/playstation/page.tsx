...
export default function PlayStationPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const plataformasPlayStation = Array.from(
        new Set(juegosPlayStation.map((juego) => juego.plataforma.nombre))
      );
      setPlataformas(plataformasPlayStation);
    };
  ...
  <h1 className="text-2xl font-bold mb-4 grid place-content-center">Juegos de PlayStation</h1>
  <ul
    className="
